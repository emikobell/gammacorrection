...
DrawFormattedText(window, 'Thank you, this is the end of the experiment. \n The Gamma Data CSV has been saved to your working directory. \n Press any key to exit', 'center', 200, [255 255 255], [], [], [], [2]); % Draw completion text 200 pixels down from the top of the screen
...
writetable(PerceptualGamma, ['PerceptualGamma_' participantID '.csv']); % Save table as a CSV with the participant ID
